...
const videoboxStripContainerCss = "/*!@:host*/.sc-videobox-strip-container-h{display:flex;flex-direction:row-reverse;gap:10px;margin-top:24px;margin-bottom:24px}";
